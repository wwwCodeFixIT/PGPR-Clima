...
function MobileSidebarOverlay({
  ...
  return (
    <>
      <div
        className={cn(
          'fixed inset-0 z-overlay bg-black/50 backdrop-blur-sm transition-opacity duration-normal lg:hidden',
      ...
      <div
        className={cn(
          'fixed inset-y-0 left-0 z-modal lg:hidden transition-transform duration-normal ease-standard',
