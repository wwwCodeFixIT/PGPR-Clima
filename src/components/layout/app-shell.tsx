...
function MobileSidebarOverlay({
  ...
  return (
    <>
      <div className={cn('fixed inset-0 z-overlay bg-black/50 backdrop-blur-sm transition-opacity lg:hidden', open ? 'opacity-100 pointer-events-auto' : 'opacity-0 pointer-events-none')} onClick={onClose} aria-hidden="true" />
